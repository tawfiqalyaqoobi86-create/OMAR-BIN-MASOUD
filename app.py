...
st.components.v1.html("""
    <div style="display: flex; justify-content: space-between; align-items: center; background-color: #0b1a32; padding: 10px 15px; border: 2px solid white; color: white; font-family: 'Cairo', sans-serif; direction: rtl;">
        <div style="background-color: #1a4da1; border: 2px solid white; padding: 5px 25px; font-size: 1.5rem; font-weight: bold;" id="js-day">...</div>
        <div style="display: flex; justify-content: space-between; align-items: center; flex-grow: 1; margin: 0 20px;">
            ...
            <div style="font-size: 2.8rem; font-weight: bold; text-shadow: 0 0 10px white;" id="js-clock">00:00:00</div>
...
with tab1:
    ...
    with col1:
        ...
        st.markdown('<table style="width:100%; text-align:center; border:1px solid white; border-collapse:collapse; font-size:0.8rem; background:white; color:black;"><tr><th style="background:#1a4da1; color:white;">الحصة</th><th style="background:#1a4da1; color:white;">من</th><th style="background:#1a4da1; color:white;">إلى</th></tr><tr><td>الأولى</td><td>07:25</td><td>08:05</td></tr><tr><td>الثانية</td><td>08:10</td><td>08:50</td></tr><tr><td>الثالثة</td><td>08:55</td><td>09:35</td></tr><tr><td>الرابعة</td><td>09:40</td><td>10:20</td></tr><tr><td>الفسحة</td><td>10:20</td><td>10:45</td></tr><tr><td>الخامسة</td><td>10:45</td><td>11:25</td></tr><tr><td>السادسة</td><td>11:30</td><td>12:10</td></tr><tr><td>السابعة</td><td>12:15</td><td>12:55</td></tr><tr><td>الثامنة</td><td>13:00</td><td>13:40</td></tr></table>', unsafe_allow_html=True)
    with col2:
        st.components.v1.html("""
...
with tab2:
    ...
    now_py = datetime.datetime.now(datetime.timezone(datetime.timedelta(hours=4)))
    ...
    st.markdown(f'<h2 style="text-align:center; color:#b8d000;">المعلمين المتواجدين في الحصة {final_session if final_session else "---"}</h2>', unsafe_allow_html=True)
